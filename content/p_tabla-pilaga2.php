...
include 'class/Clases.php';
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        $consulta = $conexion->prepare(Consultas::getFiltroPilaga2($_POST));
        $consulta->execute();
        $todo = $consulta->fetchAll();
        ?>
        ...
        <div class="row"  id="tabla1" style="display: none;">
            <div class="col-xs-18 col-md-12">
                <div style="margin-top: 100px;">
                    <h2>Tabla de Unidades por tipos de presupuestos</h2>
                    <table style='float: left;'  class="table table-hover">
                        <tbody>
                        <td><strong>Escuelas</strong></td>
                        
                        <td><strong>Tipo de presupuesto</strong></td>
                        <td><strong>Total Credito original</strong></td>
                        <td><strong>Total Credito </strong></td>
                        <td><strong>Total Preventivo</strong></td>
                    </tbody>
                        <?php for ($i = 0; $i < count($todo); $i++) { ?>
                            <tr>
                                <td><?php echo $todo[$i][unidad]; ?></td>
                                
                                <td><?php echo $todo[$i][credito_original]; ?></td>
                                <td><?php echo $todo[$i][credito]; ?></td>
                                <td><?php echo $todo[$i][preventivo]; ?></td>
                            </tr>
                            <?php
