...
// get min and max values
    ...
    AmCharts.ready(function () {
        ...
        map.areasSettings = {
            ...
            color: "#CDCDCD",
            colorSolid: "#5EB7DE",
            selectedColor: "#E19A9A",
            outlineColor: "#666666",
            rollOverColor: "#E19A9A",
        ...
        map.addListener("clickMapObject", clickPunto);

        function clickPunto(event) {

            var ajax_data = {
                "id": event.mapObject.nombre_iso2
            };
            $.ajax({
                data: ajax_data,
                type: "POST",
                url: "funciones/funcion_mapa2.php",
                success: function (a) {
                    $('#info').html(a);
                }
            });
